    ...
    <>
      {data.length === 0 ? (
        ...
        <div className="grid grid-cols-12 h-screen bg-black">
          ...
          <div className="col-span-7 text-white flex flex-col justify-between my-20 pe-32 text-xl">
            <div className="flex justify-between items-center">
              <h1 className="text-5xl font-semibold text-transparent bg-gradient-to-t from-red-400 to bg-orange-400 bg-clip-text">
                {data.show?.name}
              </h1>
            ...
            <div className="flex gap-6">
              <button className="bg-gradient-to-r from-red-400 to bg-orange-400 max-w-max px-6 py-1 rounded-md" onClick={()=>{navigate('/products')}}>
                Back
              </button>
              <button className="bg-gradient-to-r from-orange-400 to bg-red-400 max-w-max px-6 py-1 rounded-md" onClick={handleOpenModal}>
                Book Now
              </button>
            </div>
